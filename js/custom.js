...
function openItem(el) {
  ...
  setTimeout(function () {
    document
      .querySelector(".portfolio-items > div:nth-child(" + index + ")")
      .classList.add("active");
    if (
      document.querySelector(
        ".portfolio-items > div:nth-child(" + (index - 1) + ")"
      )
    ) {
      document
        .querySelector(".portfolio-items > div:nth-child(" + (index - 1) + ")")
...
function backToPorfolio() {
  ...
  setTimeout(function () {
    ...
    document
      .querySelector(".portfolio-items > div.active")
      .classList.remove("active");
    if (document.querySelector(".portfolio-items > div.to-top")) {
      document
        .querySelector(".portfolio-items > div.to-top")
        .classList.remove("to-top");
    }
    if (document.querySelector(".portfolio-items > div.to-bottom")) {
      document
        .querySelector(".portfolio-items > div.to-bottom")
        .classList.remove("to-bottom");
    }
  }, 350);
  setTimeout(function () {
    paperPlay();
...
function TopProject() {
  ...
  setTimeout(function () {
    document
      .querySelector(".portfolio-items > div:nth-child(" + global_index + ")")
      .classList.remove("active");
    if (
      document.querySelector(
        ".portfolio-items > div:nth-child(" + global_index + ")"
      )
    ) {
      document
        .querySelector(".portfolio-items > div:nth-child(" + global_index + ")")
    ...
    if (
      document.querySelector(
        ".portfolio-items > div:nth-child(" + (global_index - 2) + ")"
      )
    ) {
      document
        .querySelector(
  ...
  setTimeout(function () {
    document
      .querySelector(
        ".portfolio-items > div:nth-child(" + (global_index - 1) + ")"
      )
      .classList.add("active");
    if (
      document.querySelector(
